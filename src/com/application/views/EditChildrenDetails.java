 ...
 * @author kadhush
 */
public class EditChildrenDetails {
  ...
  // Variables declaration - do not modify                     
    private javax.swing.JButton btnChildUpdate;
    private javax.swing.JButton btnChildUpdateReset;
    ...
    private javax.swing.JCheckBox chkbxUpdateBioDetails;
    private javax.swing.JCheckBox chkbxUpdateDirectorComments;
    private javax.swing.JCheckBox chkbxUpdateGuardiansDetails;
    ...
    private javax.swing.JComboBox cmbxUpdateSearch;
    ...
    private javax.swing.JScrollPane jpUpdateSearch;
    ...
    private javax.swing.JTextField txtUpdatesearch;
    ...
    private void formControls_Hook_Up() {
        //PANELS
        /*
        for (int i = 0; i < jpChildBio.getComponentCount(); i++) {
            jpChildBio.getComponent(i).setEnabled(false);
        }
        
        for (int i = 0; i < jpGuard1.getComponentCount(); i++) {
            jpGuard1.getComponent(i).setEnabled(false);
        }
        for (int i = 0; i < jpNaturalParents.getComponentCount(); i++) {
            jpNaturalParents.getComponent(i).setEnabled(false);
        }
        for (int i = 0; i < jpMaleGuardian.getComponentCount(); i++) {
            jpMaleGuardian.getComponent(i).setEnabled(false);
        }
        
        for (int i = 0; i < jpFemaleGuardian.getComponentCount(); i++) {
            jpFemaleGuardian.getComponent(i).setEnabled(false);
        }
        
        for (int i = 0; i < jpGuard2.getComponentCount(); i++) {
            jpGuard2.getComponent(i).setEnabled(false);
        }
        for (int i = 0; i < jpDirectorsComments.getComponentCount(); i++) {
            jpDirectorsComments.getComponent(i).setEnabled(false);
        }
        */
       ...
       ButtonGroup rbAttendSchl = new ButtonGroup();
        ...
        //group the controlls
        //TEXTFIELDS
        JTextField[] txt = {txtChildNumber, txtChildName, txtCourseofStudy,txtUpdatesearch, txtResidence };
        ...
        JCheckBox[] chkBx = {
            ...
            chkbxMother_FemaleGuardianDescriptionTeacher, chkbxFather_MaleGuardianDescriptionOther
               ,chkbxUpdateDirectorComments, chkbxUpdateGuardiansDetails,  chkbxUpdateBioDetails };
chkbxUpdateDirectorComments.setEnabled(false);
chkbxUpdateGuardiansDetails.setEnabled(false);
chkbxUpdateBioDetails.setEnabled(false);

        //COMBOBOX
        JComboBox[] cmbx = {
            cmbxChildLivingUnder, cmbxFather_MaleGuardianEmployment,
            cmbxMaritalStatusofParents, cmbxMother_FemaleGuardianEmployment,
            cmbxSchool, cmbxUpdateSearch};
        ...
        //BUUTTONS
        JButton[] btn = {btnChildUpdateReset, btnChildUpdate,btnChildUploadPhoto};
        //LABELS
        JLabel[] lbl ={lblPhoto};
        // SET THE CONTROLS
        JScrollPane[] jp ={ jpUpdateSearch};

        
      
// SET THE CONTROLS
        cuDataPool.setDataControls(txt, txtArea, chkBx, cmbx, rb, btn, jp, lbl);
    }
    ...
    private javax.swing.JPanel create_Interface_Hook(javax.swing.JPanel pUser) { 
        ...
        chkbxUpdateDirectorComments = new javax.swing.JCheckBox();
        chkbxUpdateBioDetails = new javax.swing.JCheckBox();
        cmbxUpdateSearch = new javax.swing.JComboBox(new String[]{"CHILD NUMBER:"});
        txtUpdatesearch = new javax.swing.JTextField();
        chkbxUpdateGuardiansDetails = new javax.swing.JCheckBox();
        jpUpdateSearch = new javax.swing.JScrollPane();
        ...
        btnChildUpdateReset = new javax.swing.JButton();
        btnChildUpdate = new javax.swing.JButton();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2), javax.swing.BorderFactory.createTitledBorder(null, "CHILD DETAILS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12)))); // NOI18N

        jPanel2.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2), javax.swing.BorderFactory.createTitledBorder("Filter Panel")));

        chkbxUpdateDirectorComments.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        chkbxUpdateDirectorComments.setText("EDIT DIRECTOR COMMENTS");

        chkbxUpdateBioDetails.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        chkbxUpdateBioDetails.setText("EDIT BIO DETAILS");

        cmbxUpdateSearch.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        
        chkbxUpdateGuardiansDetails.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        chkbxUpdateGuardiansDetails.setText("EDIT GUARDIANS DETAILS");

        jpUpdateSearch.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addComponent(cmbxUpdateSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtUpdatesearch, javax.swing.GroupLayout.DEFAULT_SIZE, 271, Short.MAX_VALUE)
                .addGap(31, 31, 31)
                .addComponent(chkbxUpdateBioDetails)
                .addGap(38, 38, 38)
                .addComponent(chkbxUpdateGuardiansDetails)
                .addGap(18, 18, 18)
                .addComponent(chkbxUpdateDirectorComments)
                .addGap(20, 20, 20))
            .addComponent(jpUpdateSearch)
        );
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cmbxUpdateSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtUpdatesearch, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(chkbxUpdateBioDetails, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(chkbxUpdateGuardiansDetails, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(chkbxUpdateDirectorComments, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(37, 37, 37)
                .addComponent(jpUpdateSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 3, Short.MAX_VALUE))
        );

        jPanel10.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2), javax.swing.BorderFactory.createTitledBorder(null, "CHILD DETAILS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12)))); // NOI18N
        ...
        jPanel17.setBorder(javax.swing.BorderFactory.createCompoundBorder(null, javax.swing.BorderFactory.createTitledBorder(null, "GUARDIAN'S DETAILS [2]", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12)))); // NOI18N

        jPanel13.setBorder(javax.swing.BorderFactory.createCompoundBorder(null, javax.swing.BorderFactory.createTitledBorder(null, "FATHER OR MALE GUARDIAN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12)))); // NOI18N
        ...
        jPanel14.setBorder(javax.swing.BorderFactory.createCompoundBorder(null, javax.swing.BorderFactory.createTitledBorder(null, "MOTHER OR FEMALE GUARDIAN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12)))); // NOI18N
        ...
        btnChildUpdateReset.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnChildUpdateReset.setText("RESET");

        btnChildUpdate.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnChildUpdate.setText("UPDATE");

        jScrollPane2.setBorder(null);

        jPanel12.setBorder(null);

        jPanel18.setBorder(javax.swing.BorderFactory.createCompoundBorder(null, javax.swing.BorderFactory.createTitledBorder(null, "CHILD'S BIO DATA", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12)))); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createCompoundBorder(null, javax.swing.BorderFactory.createTitledBorder(null, "GUARDIANS DETAILS [1]", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12)))); // NOI18N
        ...
        jPanel19.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "NATUTAL MOTHER", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        jPanel16Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel16Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(btnChildUpdateReset, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(btnChildUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel16Layout.setVerticalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnChildUpdateReset, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnChildUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(7, 7, 7))
            .addGroup(jPanel16Layout.createSequentialGroup()
